...
3. On Learning SQL, Python, GitHub, etc.
    ...
    - And with regard to [Python](https://www.python.org/), what I know mostly about it is that people I know who are more connected to engineering, or who are more connected to doing work with data coming from apps on the internet, find Python more helpful. [Anaconda](https://www.anaconda.com/) claims to be the most popular data science platform for Python, and comes recommended by people in the class with Python experience. [Orange](https://orange.biolab.si/) may also be worth a little of your time. You may be interested in the [pandas package](http://pandas.pydata.org/) for data manipulation, and [here](http://www.statsmodels.org/stable/examples/index.html) are some [links](https://docs.scipy.org/doc/scipy/reference/stats.html#module-scipy.stats) about [statistics](http://scikit-learn.org/stable/) in Python. If you want to build Web apps, apparently [Django](https://www.djangoproject.com/) is something you should know about, too. Despite my fondness for Monty Python, I've never used Python to do anything meaningful.
