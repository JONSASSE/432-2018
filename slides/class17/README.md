...
- At this point, there are no [slides](https://github.com/THOMASELOVE/432-2018/tree/master/slides/class17). If I do build some before class, there will only be a few, as there are a lot of announcements today, and I want to leave substantial time for project 1 group work. We will cover material from [Chapter 16 in the Course Notes](https://thomaselove.github.io/432-notes/colorectal-cancer-screening-and-some-special-cases.html), and I may choose to do that straight from the Notes.
