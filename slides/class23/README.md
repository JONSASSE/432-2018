...
- The [slides](https://github.com/THOMASELOVE/432-2018/tree/master/slides/class23) are now posted.
- The [audio files](https://github.com/THOMASELOVE/432-2018/tree/master/slides/class23) are also posted.
...
- Does our data set need to be larger than the one we used in Project 1?
    ...
    - My #1 concern is that you'll try to do more than you can reasonably present (or I can reasonably evaluate) in a 20-minute presentation window.
...
4. A hint for [Homework 6](https://github.com/THOMASELOVE/432-2018/tree/master/assignments/hw6) (and for your Project, potentially):
...
5. Remember that the Project 2 Registration (and Scheduling) [Google Form](https://goo.gl/forms/Zfgnq5pyAAzAlmUm1) is due 2018-04-17, but the sooner the better. A few people have completed it successfully, and others need to revise and resubmit (which you can do by editing the form using the link that is automatically emailed to you when you submit the form.) 
