...
6. **Installing vs. Updating vs. Loading Packages** All of the packages we've introduced recently were installed by you in R at the beginning of the semester, following the instructions at https://github.com/THOMASELOVE/432-2018/blob/master/data-and-code/PACKAGES.MD, or at any rate, that was what you were supposed to do. You install a package once, you load it (with the library command) as you need it in an individual session. If you've updated your R Studio, you shouldn't need to reinstall packages, just update them. If you've updated R itself, then you need to re-install.
    - So, installing a package is something you do every time you install a new version of R. This happens rarely, maybe twice this semester. The current version of R I am running is 3.4.3, but there will be a new version (probably 3.5.0) later this semester, I believe. 
    - Updating your packages is a good idea, probably on about a weekly basis. If you're getting an error message about a package, an update will sometimes fix that problem. Start a fresh R Studio session, and then, in R Studio, go to the Packages tab on the lower right, and click on Update. You'll also update after you install a new version of R Studio. The current version of R Studio I am running is 1.1.423.
