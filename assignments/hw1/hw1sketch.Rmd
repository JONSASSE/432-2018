...
date: "Due 2018-01-26. Version: `r Sys.Date()`"
output: 
  pdf_document:
    toc: TRUE
...
**Note**: It's good practice not to load any more than you must, although you should install [the complete list of packages on our web site](https://github.com/THOMASELOVE/432-2018/blob/master/data-and-code/PACKAGES.MD).
